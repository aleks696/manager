            ...
            <div class="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg">
                <div class="d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1">
                    ...
                    <form id="passwordForm">
                        ...
                        <input type="number" id="passwordLength" name="passwordLength" min="1"><br><br>
                        <button class="btn btn-success w-50 py-2" type="button" id="generateBtn">Generate Password</button>
                    </form><br>
                    <div class="active" id="generatedPassword"></div><br><br>
                    <button type="button" id="saveBtn" style="display: none;">Save Password</button><br>
                </div>
            </div>
        </div>
    </div>
